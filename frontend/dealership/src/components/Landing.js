...
import './Landing.css';
import hero_section_img from './img/hero-section.jpg'
  ...
  return(
    <div className="Landing">
      <header className="App-header">
        <h1>Welcome to CarGo Dealership</h1>
      </header>
      <main className="App">
        <section className="hero">
          <div className="hero-text">
            <h2>We offer the best deals on new and used cars</h2>
            <p>Visit us today to find your dream car.</p>
          </div>
